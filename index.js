...
// document.write('La transformacipon de ' + grados + ' Celsius a Kelvin es: ' + kelvin + ' K' + '<br>');
// document.write('La transformacipon de ' + grados + ' Celsius a Fahrenheiit es: ' + fahrenheit + ' °F' + '<br>');
